...
[JSFiddle example here.](https://jsfiddle.net/gh/get/library/pure/onfido/velocity-sdk-ui/tree/master/demo/fiddle/)
...
```sh
$ npm install --save velocity-sdk-ui
```
...
var Onfido = require('velocity-sdk-ui')
```
...
Please open an issue through [GitHub](https://github.com/onfido/velocity-sdk-ui/issues). Please be as detailed as you can. Remember **not** to submit your token in the issue. Also check the closed issues to check whether it has been previously raised and answered.
